...
python /home/ubuntu/ec2pgdb/ec2pgdb_builder.py --key /home/ubuntu/.ssh/kishori.konwar.csv --role-type worker  --process extract --readyqueue ready_extract --worker_dir ~/ec2pgdb/pwy_extract/ --runningqueue running_extract --completequeue complete_extract
